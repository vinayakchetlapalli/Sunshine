...
import com.example.vin.sunshine.data.WeatherContract;
import com.example.vin.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(locationCursor.moveToFirst()) {
            ...
            id = locationCursor.getLong(locationID);
        }
        else {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                inserted = mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cArray);
            }
    ...
    protected void doInBackground(String... params) {
        ...
        String units = "metric";
        int numDays = 14;
        String key = "7bf2af36b898c883c96663372152705c";
